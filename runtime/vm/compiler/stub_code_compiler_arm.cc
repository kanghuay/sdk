...
#error Unimplemented
  ...
  __ LoadFromOffset(R9, THR,
                    target::Thread::top_exit_frame_info_offset());
  __ StoreToOffset(R8, THR,
                   target::Thread::top_exit_frame_info_offset());
...
#error Unimplemented
  ...
  // Restore the frame pointer and return.
  READS_RETURN_ADDRESS_FROM_LR(__ LeaveFrame((1 << FP) | (1 << LR)));
  __ Drop(1);
  __ Ret();
}
