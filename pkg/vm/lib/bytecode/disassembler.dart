...
class BytecodeDisassembler {
  ...
  void _init(List<int> bytecode) {
    ...
    _instructions = new List<Instruction>.empty(growable: true);
  ...
  void _markTryBlocks(ExceptionsTable exceptionsTable) {
    for (var tryBlock in exceptionsTable.blocks) {
      ...
      if (tryBlock.endPC != null) _addMarker(tryBlock.endPC!, 'Try #$tryIndex end:');
      if (tryBlock.handlerPC != null) _addMarker(tryBlock.handlerPC!, 'Try #$tryIndex handler:');
    }
  }
