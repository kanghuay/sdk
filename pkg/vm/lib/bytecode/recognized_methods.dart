...
class RecognizedMethods {
  ...
  bool isInt(DartType type) =>
      type == staticTypeContext.typeEnvironment.coreTypes.intLegacyRawType || type==staticTypeContext.typeEnvironment.coreTypes.intNullableRawType
  || type==staticTypeContext.typeEnvironment.coreTypes.intNonNullableRawType;

  bool isDouble(DartType type) =>
      type == staticTypeContext.typeEnvironment.coreTypes.doubleLegacyRawType || type==staticTypeContext.typeEnvironment.coreTypes.doubleNonNullableRawType
